...
function MeSection() {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8 lg:gap-12 mt-11 sm:mt-[60px] mb-8 sm:mb-[50px] w-full flex-1">
      {/* <!-- Text --> */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center lg:justify-start items-center lg:items-start text-center lg:text-left -order-2 lg:order-1 lg:mt-14">
        ...
        <p className="mt-4 lg:mt-[20px] text-md sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
        ...
        <p className="mt-2 lg:mt-[5px] text-md sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
      ...
      {/* <!-- Image --> */}
      <div className="w-full lg:w-1/2 flex justify-center items-center order-1 lg:order-2 pt-1 sm:pt-20 lg:pt-10 ">
        <img
