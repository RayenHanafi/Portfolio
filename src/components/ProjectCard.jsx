  ...
  return (
    <div className="projectCard">
      ...
      <div className="w-full md:w-1/2 p-3 sm:p-4 lg:p-12 flex flex-col justify-center text-gray-800">
        ...
        <h4 className="text-lg sm:text-xl lg:text-2xl font-semibold mb-4 sm:mb-1 lg:mb-6 text-gray-800">
          Description
        </h4>

        <p className="text-xs sm:text-base lg:text-base leading-relaxed text-gray-700">
          {project.description}
        </p>
      </div>
    </div>
